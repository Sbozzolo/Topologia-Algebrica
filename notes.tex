...
\begin{definition}
  ...
  \end{enumerate}
  Gli elementi di $ \mathcal{T} $ sono detti aperti.
\end{definition}
...
\begin{definition}
  ...
  il simbolo $ \simeq $.
\end{definition}
Siccome gli omomorfismi sono mappe uno a uno due spazi omeomorfi sono essenzialmente identici. Molti
