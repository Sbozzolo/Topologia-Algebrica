...
\begin{proof}
  ...
  \emph{Secondo me qui bisogna fare una traslazione e portare p in zero prima di fare questa trasformazione. - Si può fare perché la traslazione è un omeomorfismo}
