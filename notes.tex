...
\begin{proof}
  Per assurdo $ f : \RN{2} \homoto \RN{N} $ è un omomorfismo con
...
Definisco $ h: \Delta_1 \to X $ in modo tale che $ h(\Delta) = \alpha $ dove $ \alpha $ è un \textbf{arco}, \index{Arco} ovvero una funzione
...
\begin{definition}
  ...
  \end{itemize}
  La relazione $ \sim_H $ è detta \textbf{relazione di omotopia} \index{Relazione di omotopia} e si dimostra essere una relazione di equivalenza.
\end{definition}
[FIGURA]
