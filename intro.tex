...
\begin{osservation}
  Tutti gli spazi contraibili sono semplicemente connessi, ma non tutti gli
  spazi semplicemente connessi sono contraibili, come ad esempio $ \Sph{2} $.
  Non è banale dimostrare che $ \Sph{2} $ non è contraibile, il modo più
  semplice per farlo richiede strumenti più avanzati che verranno sviluppati più
