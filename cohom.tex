...
\begin{osservation}
  ...
  \[
    H_n(X) \otimes (\Z^{r_n} \oplus T) \cong H_n(X) \otimes \Z^{r_n} \oplus H_n(X) \otimes T
  \]
  ...
  \begin{gather*}
    H_n(X) \otimes \Z^{r_n} \cong (\Z^{s_n} \oplus T') \otimes \Z^r \cong \Z^{s_n r_n} \oplus \Z^{r_n} \otimes T' \cong \Z^{s_nr_n} \\
    H_n(X) \otimes T = (\Z^{s_n} \oplus T') \otimes T \cong T' \otimes T
  \end{gather*}
  infatti
  $ \Z^k \otimes T' = (\Z \oplus \Z \dots ) \otimes T' = (\Z \otimes T')^k = T'^k $ in quanto
  $ \Z $ è libero.
...
\begin{proof} \emph{Idee della dimostrazione}.
  ...
  Considero questa esaustione $ f $ per $ X $ varietà differenziabile, si definiscono
  gli insiemi compatti $ \tilde{A}_n = f^{-1}((-\infty, n])  $ e gli insiemi
  \[
