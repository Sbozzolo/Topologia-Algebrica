...
\begin{definition}
  ...
  se è una varietà topologica di dimensione $ n $ e possiede un \textbf{atlante}\index{Atlante},
  ...
  \item Ogni punto $ p \in \M $ possiede almeno un intorno $ U_\alpha $ che lo contiene.
  \item I cambiamenti di coordinate siano buoni, cioè date due carte
    $ \phi \colon A_1 \to \RN{n} $, $ \phi_2 \colon A_2 \to \RN{n} $ con
